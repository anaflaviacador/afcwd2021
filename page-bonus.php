		...
		while (have_posts()) : the_post();
			echo '<section class="container area-artigo" style="margin-top:0">';
				...
				echo '<aside class="colmenor">';
					...
					echo '<p style="font-size:.8em;margin-bottom:10px">Todos os materiais ao lado são cópias originais, adquiridas em nome do studio '.do_shortcode('[afc]').' e que entram na categoria de Software Livre.</p>';
					...
					echo '<p style="font-size:.8em;margin-bottom:10px;">Embora essa página seja atualizada com frequência, o studio não fornece chaves de licença e não se responsabiliza pelo uso dos plugins baixados aqui. Também não é ofertado o serviço de update individual em seu site, exceto se for assinante de um <a href="/servicos/planos/">plano recorrente de manutenção</a> que se enquadra no serviço.</p>';
				echo '</aside>';
