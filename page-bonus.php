		...
		while (have_posts()) : the_post();
			echo '<section class="container area-artigo" style="margin-top:0">';
				...
				echo '<aside class="colmenor">';
					...
					echo '<p style="font-size:.8em;margin-bottom:10px">Todos os materiais ao lado foram adquiridos em nome do studio '.do_shortcode('[afc]').' e entram na categoria de Software Livre.</p>';
					echo '<p style="font-size:.8em;margin-bottom:10px"><em style="color:var(--cor-negacao)">Embora sejam livres, não são gratuitos</em>. Por ser uma <strong>cortesia</strong>, os plugins ao lado não atualizam automaticamente em seu site, '.$cliente.'. Para você garantir essa automação, <em style="color:var(--cor-negacao)">o ideal é comprar o plugin diretamente no site oficial do mesmo</em>, indicado pelo ícone <i style="color:var(--cor-roxo);" class="fas fa-link"></i>. Com isso, além de updates automáticos, você garante o privilégio do suporte do desenvolvedor original, que é uma maravilha! 🛠</p>';
					echo '<p style="font-size:.8em;margin-bottom:10px;">Embora essa página seja atualizada com frequência, o studio não fornece chaves de licença, não se responsabiliza pelo uso dos plugins e de suas versões disponibilizadas aqui. Também não é ofertado o serviço de update individual em seu site, exceto se for assinante de um <a href="/servicos/planos/">plano recorrente de manutenção</a> que se enquadra no serviço.</p>';
				echo '</aside>';
