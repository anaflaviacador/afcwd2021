			...
			echo '<section class="todos-planos">';
				...
				echo '<div class="plano">';
					echo '<header>';
						...
						echo '<data><abbr title="BRL">R$</abbr><span class="valor-plano">120</span><span class="freq">/mês*</span></data>';
				...
				echo '<div class="plano">';
					echo '<header>';
						...
						echo '<data><abbr title="BRL">R$</abbr><span class="valor-plano">187</span><span class="freq">/mês*</span></data>';
