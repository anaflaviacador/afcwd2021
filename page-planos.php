			...
			echo '<section class="todos-planos">';
				...
				echo '<div class="plano">';
					echo '<header>';
						...
						echo '<data><abbr title="BRL">R$</abbr><span class="valor-plano">153</span><span class="freq">/mês*</span></data>';
					...
					echo '<footer id="basic">';
						...
						echo '<div class="botao">';
							echo '<a href="https://buy.stripe.com/00gg0OgeD0yyatifYZ" target="_blank" id="assinar-plano-basic" class="btAssinarPlano button medio azul">assinar!</a>'; 
						echo '</div>';
					echo '</footer>';
				echo '</div>';
				...
				echo '<div class="plano">';
					echo '<header>';
						...
						echo '<data><abbr title="BRL">R$</abbr><span class="valor-plano">255</span><span class="freq">/mês*</span></data>';
					...
					echo '<footer id="standard">';
						echo $cancela;
						echo '<div class="botao">';
							echo '<a href="https://buy.stripe.com/28o01Q8Mbchgati4gi" target="_blank" id="assinar-plano-standard" class="btAssinarPlano button medio verde">assinar!</a>';
						echo '</div>';
					echo '</footer>';
				echo '</div>';
				...
				echo '<div class="plano">';
					echo '<header>';
						...
						echo '<data><abbr title="BRL">R$</abbr><span class="valor-plano">467</span><span class="freq">/mês*</span></data>';
					...
					echo '<footer id="premium">';
						echo $cancela;
						echo '<div class="botao">';
							echo '<a href="https://buy.stripe.com/4gweWKbYn4OOcBq7sv" target="_blank" id="assinar-plano-premium" class="btAssinarPlano button medio">assinar!</a>'; 
						echo '</div>';
					echo '</footer>';
				echo '</div>';
