...
echo '<div class="wp-block-columns afclp-faq abinhas">';
	...
	echo '<div class="wp-block-column">';
		...
		echo '<div class="aba">';
			...
			echo '<div class="aba-conteudo">';
				...
				echo '<p>Entrentanto, é importante entender que a velocidade de um site depende de vários fatores que vão muito além do próprio layout. Exemplo: quantidade de plugins usados e seu nível de requerimento de servidor, saúde do banco de dados, nível de otimização das imagens e seu volume mostrado nas páginas, configurações de cache, versão defasada da plataforma Wordpress, versão de PHP, qualidade e localização, uso de CDN etc.</p>';
	...
	echo '<div class="wp-block-column">';
		...
		echo '<div class="aba" style="margin-top: 20px;">';
			...
			echo '<div class="aba-conteudo">';
				...
				echo '<p>Os canais de suporte são <a href="https://afcweb.design/contato" target="_blank">por email</a> e <a href="https://api.whatsapp.com/send?phone=5562996269941" target="_blank">whatsapp</a>, funcionando de segunda à sexta, das 14h às 17h.</p>';
			echo '</div>';
		echo '</div>';
		...
		echo '<div class="aba">';
			...
			echo '<div class="aba-conteudo">';
				...
				echo '<p>O prazo de suporte orfertado originalmente é de 6 meses, podendo ser estendido para 1 ano, cobrindo toda licença.</p>';
				echo '<p>Os canais de suporte são <a href="https://afcweb.design/contato" target="_blank">por email</a> e <a href="https://api.whatsapp.com/send?phone=5562996269941" target="_blank">whatsapp</a>, funcionando de segunda à sexta, das 14h às 17h.</p>';
			echo '</div>';
		echo '</div>';
		...
		echo '<div class="aba">';
			...
			echo '<div class="aba-conteudo">';
				...
				echo '- Problemas provenientes de mal uso e edição no código-fonte original do '.$nomeproduto.' ou da extensão para Woocommerce realizados diretamente por você ou outras pessoas;<br>';
		...
		echo '<div class="aba">';
			...
			echo '<div class="aba-conteudo">';
				echo '<p>O Aurora pode potencializar a conversão de suas vendas, captura de leads e reter por mais tempo os visitantes em seu blog por conta do seu design e sua performance. Entretanto, ele não é capaz de fazer um milagre sozinho &mdash; nenhum template é capaz de fazer esse papel.<p>';
	...
	echo '<div class="wp-block-column">';		
		...
		echo '<div class="aba">';
			...
			echo '<div class="aba-conteudo">';
				echo '<p>A licença é individual e intransvisível, ou seja, só você poderá usa-lo e só você poderá ter acesso ao suporte! </p>';
...
echo '<p class="has-text-align-center" style="margin-top: 3em; margin-bottom: 20px"><em>Retirou todas as dúvidas?</em><br><a class="button roxo medio jump" href="#comprar">Sim, quero o tema agora!</a></p>';
