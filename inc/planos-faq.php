	...
	echo '<div class="wp-block-column">';
		...
		echo '<div class="aba">';
			...
			echo '<div class="aba-conteudo">';
				...
				echo '<p>Por ser constante, a hora do serviço fica mais acessível, com economia de 10% a 45% se comparado a um serviço equivalente <em>(em horas trabalhadas)</em> fora do plano.</p>';
			echo '</div>';
		echo '</div>';
		echo '<div class="aba">';
		...
		echo '<div class="aba">';
			echo '<div class="aba-titulo">O que são edições de baixa e média complexidade no layout?</div>';
			echo '<div class="aba-conteudo">';
				...
				echo '<p><strong>Média complexidade:</strong> são mudanças que afetam diretamente estrutura do layout como adição de novas sessões numa página, criação de um bloco de conteúdo personalizado, adição de um novo menu, criação de popups, formulários de captura, remanejamento de elementos, adequações de plugins etc. São edições que geralmente exigem a criação de novas ferramentas com até 4h de produção. Pode haver algumas mudanças pontuais na identidade. É um benefício presente apenas no plano <em style="color:var(--cor-roxo);">premium</em>.</p>';
				echo '<p><strong>Atenção:</strong> Mudanças significativas no design, como troca de toda identidade visual e paleta de cores completa poderão implicar na criação de um novo projeto. Já a criação de ferramentas complexas (+4h de edição), será considerado como um serviço avulso, cotado por hora, independente do plano.</p>';
			echo '</div>';
		echo '</div>';
		echo '<div class="aba">';
