...
echo '<div class="wp-block-columns abinhas">';
	...
	echo '<div class="wp-block-column">';
		...
		echo '<div class="aba">';
			...
			echo '<div class="aba-conteudo">';
				echo '<p>Sim, é 100% seguro! O gateway de pagamento que o studio usa é o <em>Paypal</em>, o mais conceituado do mercado brasileiro. Toda transação é realizada dentro das dependências do site do Paypal.</p>';
				echo '<p>A solicitação de pagamento aqui do site é enviada para o servidor do Paypal através de um código criptografado. Depois, o Paypal fará a solicitação ao seu cartão de crédito, que dá um ok para o Paypal e faz o registro do pedido. Tudo isso em questão de segundos!</p>';
				echo '<p><strong>O studio não tem acesso algum à sua conta Paypal</strong>, muito menos sabe qual cartão que está vinculado. Como é transação direto entre contas Paypal, nem fica registrado aqui no site, apenas na conta Paypal do Studio e na sua conta, onde você <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_subscr-find&alias=37TT2GXYG7K54" target="_blank">poderá cancelar a hora que quiser</a>!</p>';
			echo '</div>';
		echo '</div>';
		echo '<div class="aba">';
	...
	echo '<div class="wp-block-column">';
		...
		// 			echo '</tr>';
		// 			echo '<tr>';
		// 				echo '<td><a href="http://pag.ae/7WxZHoZet" target="_blank" class="button azul">assinar</a></td>';
		// 				echo '<td><a href="http://pag.ae/7WxZLvFB8" target="_blank" class="button verde">assinar</a></td>';
		// 				echo '<td><a href="http://pag.ae/7WxZNSzzu" target="_blank" class="button roxo">assinar</a></td>';
		// 			echo '</tr>';									
		// 		echo '</table>';
		// 	echo '</div>';
		// echo '</div>';
		echo '<div class="aba">';
			echo '<div class="aba-titulo">Preciso ter conta Paypal para assinar um plano?</div>';
			echo '<div class="aba-conteudo">';
				echo '<p>Sim. O Paypal é lider no mercado mundial quando se trata de transações financeiras. A conta é grátis e 100% segura. É necessário ter o cadastro do seu cartão de crédito na conta para que ocorra a cobrança.</p>';
			echo '</div>';
		echo '</div>';
		echo '<div class="aba">';
		...
		echo '<div class="aba">';
			...
			echo '<div class="aba-conteudo">';
				...
				echo '<p>Para cancelar é só seguir clicar abaixo</p>';
				echo '<a href="https://www.paypal.com/cgi-bin/webscr?cmd=_subscr-find&alias=37TT2GXYG7K54" target="_blank" class="button">cancelar assinatura</a>';
				echo '<p>Caso tenha alguma dúvida ou está com problemas no cancelamento, entre em contato diretamente comigo ou vá em Paypal > Configurações > Pagamentos > Gerenciar Pagamentos Recorrentes. </p>';
			echo '</div>';
		echo '</div>';
		echo '<div class="aba">';
