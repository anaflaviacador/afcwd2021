...
echo '<div class="wp-block-columns abinhas">';
	...
	echo '<div class="wp-block-column">';
		...
		echo '<div class="aba">';
			...
			echo '<div class="aba-conteudo">';
				echo '<p>No início da garantia, a manutenção realizada na implementação do layout é semelhante ao plano <em style="color:var(--cor-azul);">basic</em> nas ações preventivas. Durante 90 dias corridos o studio cobre qualquer problema de funcionamento e bugs provenientes do layout implementado &mdash; benefício que só tem nos planos <em style="color:var(--cor-verde);">standard</em> e <em style="color:var(--cor-roxo);">premium</em>.</p>';
				echo '<p>Desta forma, para manter os benefícios básicos e todos os outros é interessante ter um plano mensal de acordo com o perfil do seu website para manter a sua saúde plena a longo prazo. 🥰</p>';
			echo '</div>';
		echo '</div>';
	...
	echo '<div class="wp-block-column">';
		...
		echo '<div class="aba">';
			...
			echo '<div class="aba-conteudo">';
				echo '<p>Os valores dos planos para clientes que possuem layout de terceiros são contabilizados de forma mais fiel ao preço cheio da hora trabalhada avulsa para cobrir possíveis complexidades inesperadas de código por conta da produção terceirizada. Cada designer / desenvolvedor tem sua forma de trabalhar.</p>';
				echo '<p>O código dos temas Wordpress do studio é 100% autoral, produzido sob uma metodologia que prevê edições na fase de pós-produção. Com isso, o processo de edição e de diagnóstico de solução de problemas é realizado com maior facilidade.</p>';
			echo '</div>';
		echo '</div>';
		echo '<div class="aba">';
