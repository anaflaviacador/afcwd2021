...
echo '<div class="wp-block-columns abinhas">';
	...
	echo '<div class="wp-block-column">';
		...
		echo '<div class="aba">';
			...
			echo '<div class="aba-conteudo">';
				echo '<p>Você tem 7 dias corridos após adesão do seu plano para cancela-lo sem descontar do seu cartão de crédito.</p>';
				echo '<p><strong>Será descontado automaticamente do seu cartão apenas no 8º dia após a adesão</strong> e, após esse período, não há reembolso, apenas o pedido de cancelamento da renovação.</p>';
				...
				echo '<p>Após nossa primeira conversa você poderá manter sua decisão de adesão ao plano ou cancela-lo sem custo até o fim do 7º dia.</p>';
			echo '</div>';
		echo '</div>';
		echo '<div class="aba">';
	...
	echo '<div class="wp-block-column">';
		...
		echo '</div>';
		echo '<div class="aba">';
			echo '<div class="aba-titulo">Cancelei dias após à renovação do plano e quero cancelar. Posso ter meu dinheiro de volta da última recorrência nesse caso?</div>';
			echo '<div class="aba-conteudo">';
