...
echo '<div class="wp-block-columns abinhas">';
	...
	echo '<div class="wp-block-column">';
		...
		echo '<div class="aba">';
			...
			echo '<div class="aba-conteudo">';
				echo '<p>Sim, é 100% seguro! O gateway de pagamento que o studio usa é o <em>PagSeguro UOL (Pagbank)</em>, o mais conceituado do mercado brasileiro. Toda transação é realizada dentro das dependências do site do PagSeguro.</p>';
			echo '</div>';
		echo '</div>';
		echo '<div class="aba">';
	...
	echo '<div class="wp-block-column">';
		...
		echo '</div>';
		echo '<div class="aba">';
			echo '<div class="aba-titulo">Preciso ter conta PagSeguro para assinar um plano?</div>';
			echo '<div class="aba-conteudo">';
				echo '<p>Não é necessário, mas é interessante ter! É grátis e fica muito mais fácil de manusear seus dados de pagamento e, principalmente, facilidade para cancelar sua assinatura.</p>';
			echo '</div>';
		echo '</div>';
		echo '<div class="aba">';
		...
		echo '<div class="aba">';
			...
			echo '<div class="aba-conteudo">';
				echo '<p>Sim! Basta cancelar sua assinatura atual e aderir ao plano desejado.</p>';
			echo '</div>';
		echo '</div>';
		echo '<div class="aba">';
			...
			echo '<div class="aba-conteudo">';
				...
				echo '</p>';
				echo '<p>Caso dê algo errado com o seu cancelamento, entre em contato diretamente comigo, ok? Não é preciso entrar em contato com a prestadora do cartão nem com o suporte do PagSeguro. Tenho o controle de todas as adesões realizadas aqui no site.</p>';
			echo '</div>';
		echo '</div>';
		echo '<div class="aba">';
			echo '<div class="aba-titulo">Cancelei dias depois à renovação. Posso ter meu dinheiro de volta?</div>';
			echo '<div class="aba-conteudo">';
				echo '<p>Não, automaticamente você fará uso dos benefícios do seu plano até o período se encerrar. Após o encerramento do ciclo <em>(que pode ser de 30 ou 90 dias)</em>, não haverá renovação automática.</p>';
			echo '</div>';
		echo '</div>';
		echo '<div class="aba">';
			...
			echo '<div class="aba-conteudo">';
				...
				echo '<table class="tabela-planos-trimestrais">';
					...
					echo '</tr>';
					echo '<tr>';
						echo '<td><a href="http://pag.ae/7WxZJzdTR" target="_blank" class="button azul">assinar</a></td>';
						echo '<td><a href="http://pag.ae/7WxZMg3Sa" target="_blank" class="button verde">assinar</a></td>';
						echo '<td><a href="http://pag.ae/7WxZPu7ra" target="_blank" class="button roxo">assinar</a></td>';
					echo '</tr>';									
				echo '</table>';
